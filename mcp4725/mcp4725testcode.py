...
# Initialize I2C for the MCP4725 DAC
i2c = I2C(1, scl=Pin(15), sda=Pin(14), freq=25000)

# Create an MCP4725 DAC object
dac = MCP4725(i2c, BUS_ADDRESS[0])

# Desired output voltage in the range of 0 to 3.3V
desired_voltage = 3.3
# Change this to your desired voltage value

# Scale the desired voltage to the range 0 to 4095 (12-bit resolution)
dac_value = int((desired_voltage / 3.3) * 4095)

# Set DAC output value to the scaled value
dac.write(dac_value)
